...
ROOT_DIR = "F:/YAZILIM MÜHENDİSLİĞİ/4.SINIF/Yapay Zeka/LAB/Ödevler/Python Dosyaları/Verisetleri/cats_dogs/"
CSV_PATH = "F:/YAZILIM MÜHENDİSLİĞİ/4.SINIF/Yapay Zeka/LAB/Ödevler/Python Dosyaları/Verisetleri/cats_dogs/train_test_split.csv"
...
model.add(Conv1D(160,4,strides=2,activation='relu'))
model.add(BatchNormalization())
model.add(Conv1D(160,4,strides=2,activation='relu'))
model.add(BatchNormalization())
model.add(GlobalAveragePooling1D())
