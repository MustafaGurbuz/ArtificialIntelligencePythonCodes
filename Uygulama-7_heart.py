...
ROOT_DIR = "F:/YAZILIM MÜHENDİSLİĞİ/4.SINIF/Yapay Zeka/LAB/Ödevler/Python Dosyaları/Verisetleri/heartbeat_sounds/"
CSV_PATH = "F:/YAZILIM MÜHENDİSLİĞİ/4.SINIF/Yapay Zeka/LAB/Ödevler/Python Dosyaları/Verisetleri/heartbeat_sounds/set.csv"
...
def dataset_gen(is_train=True, batch_shape=(20, 16000), sample_augmentation=0):
    ...
    X_cat = df['set_a'] if is_train else df['set_b']
    X_dog = df['set_b'] if is_train else df['set_a']
